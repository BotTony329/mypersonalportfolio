...
export type SectorId =
  | "hero" | "missions" | "case01" | "case02" | "resp" | "skills" | "contact";

export const CAMERA: Record<SectorId, CameraState> = {
  hero:     { zoom: 1.00, x:  0.00, y:  0.19, intensity: 1.00, tilt: 0.36, warp: 0.00, dim: 0.00 },
  missions: { zoom: 1.42, x:  0.46, y: -0.06, intensity: 0.30, tilt: 0.30, warp: 0.35, dim: 0.55 },
  case01:   { zoom: 2.05, x: -0.52, y:  0.14, intensity: 0.20, tilt: 0.55, warp: 0.55, dim: 0.72 },
  case02:   { zoom: 2.55, x:  0.58, y: -0.16, intensity: 0.18, tilt: 0.15, warp: 0.60, dim: 0.74 },
  resp:     { zoom: 2.20, x:  0.30, y:  0.20, intensity: 0.18, tilt: 0.24, warp: 0.45, dim: 0.72 },
...
export const SECTOR_LABEL: Record<SectorId, string> = {
  hero: "HERO", missions: "CTRL", case01: "AI-01",
  case02: "ENT-02", resp: "ENT-02", skills: "ARRAY", contact: "COMMS",
};
